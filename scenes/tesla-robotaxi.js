...
(() => {
  ...
  async function loadStudio() {
    ...
    try {
      ...
      // The supplied reference image remains visible when WebGL/modules are unavailable.
      console.warn('Cybercab 3D unavailable; reference image retained.',error.message);
    }
  }
